"""
TITLE  : Logistic regression applied to the wine dataset with pca
AUTHOR : Salman Shah
DATE   : Wed May 23 19:19:20 2019

Implemented for the sake of experimentation with decision trees and random forests
"""
...
plt.title("k-NN on Wine Dataset with PCA k=%s" % k)
ax.axis('tight')
