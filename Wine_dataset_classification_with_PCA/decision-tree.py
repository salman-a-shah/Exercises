"""
TITLE  : Decision tree applied to the wine dataset with pca
AUTHOR : Salman Shah
DATE   : Wed May 23 19:19:20 2019

Implemented for the sake of experimentation with different models
"""
...
plt.title("Decision Tree on Wine Dataset with PCA")
ax.axis('tight')
